...
<div style="text-align:center; margin-bottom:50px;">
  <img src="{{ site.baseurl }}/assets/images/NASA_Sat.jpg" width="40%">
  
  <div style="margin-top:10px; font-size:0.9em;">
    Photo Credit: NASA — Satellite Navigation
  </div>
</div>
...
<div style="text-align:center; display:block; margin-bottom:40px !important;">
  <img src="{{ site.baseurl }}/assets/images/SolarSystem.jpg" width="40%">
  
  <div style="margin-top:10px; font-size:0.9em;">
   Image Capture using Celestia open source Simulation Software— Solar System— Satellite Navigation
  </div>
</div>
